...
#         cfg.augmented_classes
    ...
    if mode == 'threeway_combined':
        ...
        real_dset = Sorted_Dataset(cfg.real, train=True, include_keys=['images', 'encodings_vgg16'], include_labels=cfg.real_classes)
        fake_dset = Sorted_Dataset(cfg.fake, train=True, include_keys=['z_values', 'images', 'encodings_vgg16'], include_labels=cfg.fake_classes)
        aug_dset = Sorted_Dataset(cfg.augmented, train=True, include_keys=['images', 'encodings_vgg16'], include_labels=cfg.augmented_classes)
        dsets = {'real':real_dset, 'fake':fake_dset, 'augmented':aug_dset}
        dataloader = Multi_Dataset_Loader(dsets, batch_size=64, shuffle=False, drop_last=False)
        return dataloader        
